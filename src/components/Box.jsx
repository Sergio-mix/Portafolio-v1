...
const Box = (props) => {
    const [image, setImage] = React.useState(props.images[Math.floor(Math.random() * (props.images.length))]);
    return (
        <div
            style={{backgroundImage: `url(${image})`}}
            onMouseOver={() => setImage(props.images[Math.floor(Math.random() * (props.images.length))])}
