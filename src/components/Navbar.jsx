...
const Navbar = () => {
    ...
    return (
        <div className='content-nav fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#FFFFFF] text-gray-300'>
            <div>
            ...
            <ul className='hidden md:flex'>
                <li>
                    <Link to='home' smooth={true} duration={500} className='text-nav'>
                        Home
                    </Link>
                </li>
                <li>
                ...
                <li>
                    <Link to='skills' smooth={true} duration={500} className='text-nav'>
                        Skills
                    </Link>
                </li>
                <li>
                    <Link to='work' smooth={true} duration={500} className='text-nav'>
                        Work
                    </Link>
                </li>
                <li>
                    <Link to='contact' smooth={true} duration={500} className='text-nav'>
                        Contact
                    </Link>
                </li>
            </ul>
                ...
                <ul>
                    ...
                    <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#333333] border-radius-12'>
                        <a
                            ...
                            href='https://github.com/Sergio-mix' target="_blank"
                        >
                    ...
                    <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#25d366] border-radius-12'>
                        <a
                            ...
                            href='https://wa.me/573222406726' target="_blank"
                        >
